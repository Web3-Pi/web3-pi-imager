...
Item {
    ...
    ColumnLayout {
        ...
        ImButton {
            ...
            onClicked: {
                console.log("MODE", window, dualMode, window.dualMode);
    ...
    function setDualMode(dualMode = true) {
        if (dualMode) {
            modeSelectorConatiner.dualMode = true
            ...
            modeSelectorConatiner.dualMode = false
